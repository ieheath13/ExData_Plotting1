...
plot(used_data$DateTime, used_data$Global_active_power, type = "n", xlab = "", ylab = "Energy Sub Metering")
...
plot(used_data$DateTime, used_data$Global_reactive_power, type = "n", xlab ="" , ylab = "Global_reactive_power")
